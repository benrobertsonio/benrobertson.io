...
This site is a [Gatsby](https://www.gatsbyjs.org) site I designed and built). The type is set in [Adobe Source Sans Pro](https://github.com/adobe-fonts/source-sans-pro).

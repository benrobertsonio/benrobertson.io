...
Hi, I’m Ben, an engineering manager in Greenville, SC for [Gatsby](https://www.gatsbyjs.com/). In my free time I enjoy hiking, spending time with my wife and children, and learning to play the banjo.
...
### Gatsby
**Engineering Manager, Customer Success** | July 2020 - Present
...
This site is a [Gatsby](https://www.gatsbyjs.org) site I designed and built using [theme-ui](https://theme-ui.com/). The type is set in [Adobe Source Sans Pro](https://github.com/adobe-fonts/source-sans-pro).
